...
9. For password reset mail->Open MailHog UI: http://127.0.0.1:8025 (for this https://github.com/mailhog/MailHog/releases/download/v1.0.1/MailHog_windows_386.exe[mailhog] needed to be installed and run .exe file of it).
